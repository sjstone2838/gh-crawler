...
class Command(BaseCommand):
    help = """
    python manage.py append_dev_profiles

    For each developer in the database, makes a call to Github API
    for developer's profile data and appends or replaces existing profile.
    """
    ...
    def handle(self, *args, **options):
        dev_ct = Developer.objects.count()
